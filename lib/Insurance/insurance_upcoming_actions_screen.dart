...
class InsuranceUpcomingActionsScreen extends StatefulWidget {
  ...
  @override
  State<InsuranceUpcomingActionsScreen> createState() => _InsuranceUpcomingActionsScreenState();
}

class _InsuranceUpcomingActionsScreenState extends State<InsuranceUpcomingActionsScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: () {},
            child: const Text('Edit', style: TextStyle(color: brandRed, fontSize: 16, fontWeight: FontWeight.w600)),
          ),
      ...
      body: _isLoading
          ...
          : _error != null
              ? Center(child: Padding(padding: const EdgeInsets.all(24), child: Text('Error: $_error', textAlign: TextAlign.center)))
              : RefreshIndicator(
                      ...
                      children: [
                        const Row(
                          ...
                          children: [
                            ...
                            Text(
                              'See All',
                              style: TextStyle(fontSize: 14, color: Color(0xFF111111), fontWeight: FontWeight.w700),
                            ),
                          ],
                        ),
                        ...
                        if (_upcomingPolicies.isEmpty)
                          const Center(
                            child: Padding(
                              ...
                              child: Text('No upcoming actions', style: TextStyle(color: Colors.grey)),
                            ),
                          )
                        else
