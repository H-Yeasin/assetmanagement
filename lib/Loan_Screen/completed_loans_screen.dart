              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    if (_completedLoans.isEmpty) {
                      return const Center(child: Padding(padding: EdgeInsets.all(40), child: Text('No completed loans', style: TextStyle(color: Colors.grey))));
                    }
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      loan.name,
                                      style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFF555555)),
                                    ),
                                    Text(
                                      NumberFormat.simpleCurrency().format(loan.totalAmount),
