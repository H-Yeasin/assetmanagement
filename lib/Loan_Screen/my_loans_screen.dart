...
class _MyLoansScreenState extends State<MyLoansScreen> {
  ...
  double get _totalMonthlyPayment {
    return _allLoans
        ...
        .fold(0.0, (sum, l) => sum + LoanCalculations.monthlyEquivalent(l));
  }
  ...
  double get _totalOutstanding {
    return _allLoans
        ...
        .fold(
          0.0,
          (sum, l) => sum + LoanCalculations.estimatedRemainingBalance(l),
        );
  }
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: GestureDetector(
                          onTap: () => context.push('/loan-payment-timeline'),
                          child: Container(
                            width: double.infinity,
                        ...
                        Padding(
                          ...
                          child: Column(
                            children: _filteredLoans.map((loan) {
                              ...
                              if (loan.category.toLowerCase().contains(
                                    'home',
                                  ) ||
                                ...
                                iconPath =
                                    'assets/images/icon/student_loan.png';
                              } else if (loan.category.toLowerCase().contains(
                                'personal',
                              )) {
                                iconPath =
                                    'assets/images/icon/personal_loan.png';
                              }
                              ...
                              return LoanListItem(
                                ...
                                amount:
                                    NumberFormat.simpleCurrency(
                                      ...
                                      LoanCalculations.monthlyEquivalent(loan),
                                    ),
                                status: loan.autoPay
                                    ? 'Paid automatically'
                                    : 'Manual payment required',
